...
def hash_password(password:str)->str:
    salt=os.urandom(16);key=hashlib.scrypt(password.encode('utf-8'),salt=salt,n=2**14,r=8,p=1,dklen=32)
...
def verify_password(stored:str,password:str)->bool:
    try:
        ...
        salt=base64.urlsafe_b64decode(salt_b64.encode());expected=base64.urlsafe_b64decode(key_b64.encode())
